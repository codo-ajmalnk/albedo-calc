...
export default function BulkUpdate() {
  ...
  // Only students under this mentor
  const initialStudents = allStudents.filter((student) => student.mentorId === user?.id);
                ...
                <form onSubmit={form.handleSubmit(handleBulkUpdate)} className="space-y-6">
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      {["status", "totalSessions", "sessionsCompleted", "totalHours", "completedHours", "totalPayment", "paidAmount", "teachersPayment", "hourlyPayment", "sessionDuration", "startDate", "endDate", "sessionAddedOn"].map((field) => (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {/* Render form fields as in admin BulkUpdate, but no mentor select */}
